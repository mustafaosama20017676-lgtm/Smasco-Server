...
// SMASCO Schemas
// ═══════════════════════════════════════════════════════════════
const SmascoInfoSchema = new mongoose.Schema(
  {
    ip: { type: String, unique: true, required: true },
...
const SmascoInfo = mongoose.models.SmascoInfo || mongoose.model("SmascoInfo", SmascoInfoSchema);

const SmascoServiceSchema = new mongoose.Schema(
  {
    ip: { type: String, required: true },
    service_type: { type: String },
    worker_nationality: { type: String },
    duration_type: { type: String },
    hours_package: { type: String },
    months_package: { type: String },
    contract_duration: { type: String },
    package: { type: String },
    amount: { type: String },
    service_start_date: { type: String },
    workers_count: { type: String },
    visit_duration: { type: String },
    visit_period: { type: String },
    visit_days: { type: String },
    pickup_time: { type: String },
    pickup_time_hours: { type: String },
    pickup_time_months: { type: String },
    requestId: { type: String },
  },
  { timestamps: { createdAt: true, updatedAt: false } }
);
const SmascoService = mongoose.models.SmascoService || mongoose.model("SmascoService", SmascoServiceSchema);
